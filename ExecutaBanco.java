...
public class ExecutaBanco {
	public static void main(String[] args){
		...
		if (ger1.adicionarCliente(c1)== true) System.out.println("Cliente '"  +c1.nome + "' adicionado corretamente.");
		else System.out.println("Cliente '"  + c1.nome + "' nao pode ser adicionado.");
		
		if (ger1.adicionarCliente(c2)==true) System.out.println("Cliente '"  +c2.nome + "' adicionado corretamente.");
		else System.out.println("Cliente '"  + c2.nome + "' nao pode ser adicionado.");
		
		if (ger1.adicionarCliente(c2)==true) System.out.println("Cliente '"  +c2.nome + "' adicionado corretamente.");
		else System.out.println("Cliente '"  + c2.nome + "' nao pode ser adicionado.");
		
		if (ger1.adicionarCliente(c3)== true) System.out.println("Cliente '"  + c3.nome + "' adicionado corretamente.");
		else System.out.println("Cliente '"  + c3.nome + "' nao pode ser adicionado.");
		
		System.out.println("*** Adicionando Clientes ao Gerente 2 **************************");
		
		if (ger2.adicionarCliente(c3)==true) System.out.println("Cliente '"  + c3.nome + "' adicionado corretamente.");
		else System.out.println("Cliente '"  + c3.nome + "' nao pode ser adicionado.");
		
		if (ger2.adicionarCliente(c4)==true) System.out.println("Cliente '"  + c4.nome + "' adicionado corretamente.");
		...
		if (c4.obterEmprestimo(20000) == true)  {System.out.println("Cliente '"  + c4.nome + "' obteve o emprestimo solicitado.");
		}
		...
		if (c2.obterEmprestimo(20000)==true) {  System.out.println("Cliente '"  + c2.nome + "' obteve o emprestimo solicitado.");
		...
		if (c2.realizarSaque(12345) == true)  System.out.println("Cliente '"  + c2.nome + "' realizou saque solicitado.");
		else  System.out.println("Cliente '"  + c2.nome + "' nao pode realizar o saque solicitado.");

		if (c2.realizarSaque(12345)==true)  System.out.println("Cliente '"  + c2.nome + "' realizou saque solicitado.");
		else  System.out.println("Cliente '"  + c2.nome + "' nao pode realizar o saque solicitado.");

		if (c1.realizarSaque(10000)==true)  System.out.println("Cliente '"  + c1.nome + "' realizou saque solicitado.");
		else  System.out.println("Cliente '"  + c1.nome + "' nao pode realizar o saque solicitado.");


		if (c1.realizarSaque(1)==true)  System.out.println("Cliente '"  + c1.nome + "' realizou saque solicitado.");
		else  System.out.println("Cliente '"  + c1.nome + "' nao pode realizar o saque solicitado.");
